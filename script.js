...
const cooldown = 600000; // 10 минут в миллисекундах
...
function generateRandomNumber() {
    ...
    setTimeout(function () {
        ...
        setTimeout(showText, 10000); // Показываем текст через 10 секунд
    }, 100);
}
...
function initializeTimer() {
    startButton.addEventListener('click', function () {
        ...
        if (!timerRunning) {
            let duration = 7200; // 2 часа в секундах
            ...
            }, 9100); // 9100 миллисекунд = чуть менее 10 секунд
        }
    });
